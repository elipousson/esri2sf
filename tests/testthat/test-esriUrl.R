...
test_that("esriUrl_isValidType checks", {
  ...
  expect_message(esriUrl_isValidType("https://sampleserver1.arcgisonline.com/ArcGIS/rest/services", type = "feature", displayReason = TRUE), "`url` must end in a feature ID")
  ...
  expect_message(esriUrl_isValidType("https://sampleserver1.arcgisonline.com/ArcGIS/rest/services", type = "service", displayReason = TRUE), "`url` must end in one of the supported service types")
  expect_false(esriUrl_isValidType("https://sampleserver6.arcgisonline.com/arcgis/rest/services/Census/MapServer/3", type = "service"))
...
test_that("esriUrl_parseUrl", {
  ...
  expect_error(esriUrl_parseUrl("https://sampleserver1.arcgisonline.com/arcgis/rest/services/Census/MapServer/3"), "HTTP 503 Service Unavailable", fixed = TRUE)
})
